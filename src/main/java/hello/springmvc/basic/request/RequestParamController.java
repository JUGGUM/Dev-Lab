...
public class RequestParamController {
    ...
    /**
     * @RequestParam 사용 String, int 등의 단순 타입이면 @RequestParam 도 생략 가능 해당 애노테이션을 생략하면 스프링 MVC는 내부에서
     * required=false 를 적용한다.
     */
    @ResponseBody
     ...
     * defaultValue 사용) Integer 에는 객체형이므로 null 이들어갈수있음. 하지만 int는 null이 들어갈수가 없다.
     */
    @ResponseBody
     ...
     * (key=userIds, value=[id1, id2]) 파라미터의 값이 1개가 확실하다면 Map 을 사용해도 되지만, 그렇지 않다면 MultiValueMap 을
     * 사용하자
     */
    @ResponseBody
